...
- `.vector_cache` (containing hidden files): Glove vector storage address
...
1. First, create a conda virtual environment through `environment.yml` (which stores the project's environment configuration)
