...
\begin{figure}[!t]
\centering
\includegraphics[width=\columnwidth]{figures/fig02_gop_structure.png}
...
\end{equation}
where $W_1$, $W_2$, $b_1$, and $b_2$ are learnable parameters. The FFN is applied to each position, providing nonlinear transformation capacity complementary to the attention mechanism.
